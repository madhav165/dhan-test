...
import { DHAN_APP_ID, DHAN_APP_SECRET, DHAN_CLIENT_ID, DHAN_AUTH_URL } from '$env/static/private'
import type { RequestHandler } from './$types'

export const GET: RequestHandler = async ({ cookies }) => {
	const resp = await fetch(`${DHAN_AUTH_URL}/app/generate-consent?client_id=${DHAN_CLIENT_ID}`, {
		method: 'POST',
